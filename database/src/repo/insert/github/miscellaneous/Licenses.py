...
import json
import datetime
import database.src.repo.insert.github.common.HttpHeader
import database.src.repo.insert.github.common.HttpResponser
class Licenses:
    def __init__(self, data):
        self.data = data
        self.header = database.src.repo.insert.github.common.HttpHeader.HttpHeader(self.data)
        self.responser = database.src.repo.insert.github.common.HttpResponser.HttpResponser()
