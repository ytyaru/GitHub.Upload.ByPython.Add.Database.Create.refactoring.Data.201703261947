...
import database.src.other_repo.insert.github.common.HttpResponser
class Licenses:
    def __init__(self, data):
        self.data = data
        self.header = database.src.other_repo.insert.github.common.HttpHeader.HttpHeader(self.data)
        self.responser = database.src.other_repo.insert.github.common.HttpResponser.HttpResponser()
